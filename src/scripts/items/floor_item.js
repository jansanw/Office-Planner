...
{
	constructor(model, metadata, geometry, material, position , scale, isgltf=false)

		super(model, metadata, geometry, material, positions, scale, isgltf);
	...
	placeInRoom()
	{
		if (!this.position_set)
		{
			...
			// this.position.y = 5.0 * (this.geometry.boundingBox.max.y - this.geometry.boundingBox.min.y);
		}
	}
